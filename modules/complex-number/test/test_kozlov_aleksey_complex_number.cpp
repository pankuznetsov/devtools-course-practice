...
TEST(Kozlov_Aleksey_ComplexNumberTest, Can_Subtract) {
    // Arrange
    double re1 = 1.5;
    double im1 = 0.4;
    double re2 = 9.3;
...
TEST(Kozlov_Aleksey_ComplexNumberTest, Equality) {
    // Arrange
...
TEST(Kozlov_Aleksey_ComplexNumberTest, Double_Equality) {
    // Arrange
    ComplexNumber a(1.5, 5.4);
    ComplexNumber b(9.0, 0.1);
...
TEST(Kozlov_Aleksey_ComplexNumberTest, Divide_by_zero) {
    // Arrange
    double re1 = 1.5;
    double im1 = 0.4;
    double re2 = 0.0;
